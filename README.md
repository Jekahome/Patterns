...
Он используется для преобразования одного интерфейса в другой, необходимый клиенту. 
Адаптер обеспечивает совместимость несовместимых интерфейсов, реализуя прослойку.
...
Класс который будет работать (оборачивать ) с данными выбираем сами,гибкий механизм комбинирования объектов во время выполнения программы с целью расширения функциональности.
