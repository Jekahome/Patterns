...
Преобразование коллекции элементов применив алгоритм к каждому элементу.
...
fn main() {
    ...
    let exp: Box<Stmt> = Box::new(Stmt::Let(Box::new(Name::new(String::from("ABCD"))), Box::new(Expr::IntLit(18))));
