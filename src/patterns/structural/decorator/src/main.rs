/*
`Template Decorator` (обёртка) - суть работы паттерна заключается в "оборачивании" готового объекта новым "функционалом", 
...
Проблема
Клиент содержит сервис с различными способами доставки сообщения (email,sms,slack,facebook). 
