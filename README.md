...
* [Design principles](https://github.com/Jekahome/Patterns#design-principles-solid-kiss-dry-yagni-grasp): [SOLID](https://github.com/Jekahome/Patterns#solid), [KISS](https://github.com/Jekahome/Patterns#kiss), [DRY](https://github.com/Jekahome/Patterns#dry), [YAGNI](https://github.com/Jekahome/Patterns#yagni), [GRASP](https://github.com/Jekahome/Patterns#grasp)
...
* **Функциональное программирование** - Haskell интерпритация говорит про понятяие ссылочной прозрачности программы
...
Моя интерпритация KISS - соблюдать необходимые рекомендации разработки проекта чтобы, недопустить внесения измений в проект большими затрами сил, что-бы то разработчик мог это сделать малыми силами. Для этого, помимо использования общеизвестных паттернов и идиом технологии/языка если они уместны, еще должна быть читабельная документация, тесты, необходимые комментарии, ссылки на источники, само собой разумеется - SOLID, содержательные имена. К тому же, архитектура приложения должна предусматривать возможность внесение вероятных изменений.  
